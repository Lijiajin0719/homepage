...
const i18n = {
  zh: {
    ...
    'home.tag.us': '超声平面波重建',
    'pub.title': '学术论文',
    'pub.subtitle': '5篇已接收 · 2篇审稿中',
    'pub.filter.all': '全部',
    'pub.filter.published': '已接收',
    'pub.filter.revision': '审稿中',
  ...
  en: {
    ...
    'home.news.item3':
      'HOPE-Net submitted to IEEE JBHI (CAS Q1, IF=6.8), under review',
    'home.news.item4':
    ...
    'pub.subtitle': '5 Published · 2 Under Review',
    'pub.filter.all': 'All',
    'pub.filter.published': 'Published',
    'pub.filter.revision': 'Under Review',
